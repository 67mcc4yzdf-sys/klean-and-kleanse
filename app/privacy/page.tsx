...
export default function PrivacyPage() {
  return <><PageHero eyebrow="Legal" title="Privacy Policy" description={`Last updated ${business.legal.lastUpdated}`} showCta={false} />
    <section className="section pt-12"><div className="shell max-w-3xl space-y-8 leading-7 text-slate-600">
      ...
      <div><h2 className="text-xl font-extrabold text-ink">Your choices</h2><p className="mt-3">You may ask to review, correct, or delete information, subject to applicable legal and recordkeeping requirements. Contact <a className="font-bold text-[var(--primary)]" href={`mailto:${business.legal.privacyContact}`}>{business.legal.privacyContact}</a>.</p></div>
