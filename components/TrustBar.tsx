...
import { ArrowRight, CalendarClock, HeartHandshake, MapPin, ReceiptText, Star } from "lucide-react";
...
export default function TrustBar() {
  ...
  return <section className="border-y border-slate-200 bg-white"><div className="shell">
    <div className="grid border-b border-slate-200 lg:grid-cols-[1.15fr_2fr]">
      <Link href={proof.href} className="group flex items-center gap-4 py-5 lg:border-r lg:border-slate-200 lg:pr-8">
        <div className="flex text-amber-400" aria-label={hasVerifiedRating ? `${proof.rating} out of 5` : "Five-star feedback"}>
      ...
      <div className="grid grid-cols-2 divide-x divide-y divide-slate-200 sm:grid-cols-4 sm:divide-y-0 lg:pl-4">
